  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item {{ Request::routeIs('categories.*') ? 'active open' : '' }}">
      ...
      <ul class="menu-sub">
        ...
        <li class="menu-item {{ Request::routeIs('categories.index') || Request::routeIs('categories.edit') ? 'active' : '' }}">
    ...
    <li class="menu-item {{ Request::routeIs('events.*') ? 'active open' : '' }}">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
      ...
      <ul class="menu-sub">
        <!-- Menu Tambah Event -->
        <li class="menu-item {{ Request::routeIs('events.create') ? 'active' : '' }}">
          <a href="{{ route('events.create') }}" class="menu-link">
            <div data-i18n="Basic">Tambah Data</div>
          </a>
        </li>
        <!-- Menu Daftar Event -->
        <li class="menu-item {{ Request::routeIs('events.index') || Request::routeIs('events.edit') ? 'active' : '' }}">
          <a href="{{ route('events.index') }}" class="menu-link">
            <div data-i18n="Basic">Data Event</div>
          </a>
        </li>
      </ul>
    </li>
    <li class="menu-item {{ Request::routeIs('instructors.*') ? 'active open' : '' }}">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bx-calendar"></i>
      ...
      <ul class="menu-sub">
        <!-- Menu Tambah Event -->
        <li class="menu-item {{ Request::routeIs('instructors.create') ? 'active' : '' }}">
          <a href="{{ route('instructors.create') }}" class="menu-link">
            <div data-i18n="Basic">Tambah Data</div>
          </a>
        </li>
        <!-- Menu Daftar Event -->
        <li class="menu-item {{ Request::routeIs('instructors.index') || Request::routeIs('instructors.edit') ? 'active' : '' }}">
    ...
    <li class="menu-item {{ Request::routeIs('admin.registrations.*') ? 'active' : '' }}">
      <a href="{{ route('admin.registrations.index') }}" class="menu-link">
        ...
        <div data-i18n="Verifikasi">Verifikasi Pembayaran</div>
      </a>
    </li>
  </ul>
</aside>
